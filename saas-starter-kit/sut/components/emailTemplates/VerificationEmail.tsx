  ...
  return (
    <Html>
      ...
      <EmailLayout>
        ...
        <Text>Thank you for signing up for {app.name}. To confirm your account, please click the button below.</Text>
        <Container className="text-center">
          <Button href={verificationLink} className="bg-brand text-white font-medium py-2 px-4 rounded">
            Confirm account
          </Button>
        </Container>
