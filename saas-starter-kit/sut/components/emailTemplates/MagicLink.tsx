  ...
  return (
    <Html>
      ...
      <EmailLayout>
        ...
        <Text>Click the button below to log in to your {app.name} account. This button will expire in 60 minutes.</Text>
        <Container className="text-center">
          <Button href={url} className="bg-brand text-white font-medium py-2 px-4 rounded">
            Log in to {app.name}
          </Button>
        </Container>
