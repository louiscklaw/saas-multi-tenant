  ...
  return (
    <Html>
      ...
      <EmailLayout>
        <Text>Hi {name},</Text>
        <Text>
          You have been successfully signed up to {app.name} on team <b>{team}</b>.
        </Text>
        <Text>Click the link below to login now:</Text>
        <Container className="text-center">
          <Button href={`${env.appUrl}/auth/login`} className="bg-brand text-white font-medium py-2 px-4 rounded">
