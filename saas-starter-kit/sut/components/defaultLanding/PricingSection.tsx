  ...
  return (
    <section className="py-6">
      <div className="flex flex-col justify-center space-y-6">
        <h2 className="text-center text-4xl font-bold normal-case">{t('pricing')}</h2>
        ...
        <div className="flex items-center justify-center">
          <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
            {plans.map((plan, index) => {
              return (
                <Card key={`plan-${index}`} className="rounded-md dark:border-gray-200 border border-gray-300">
                  <Card.Body>
                    <Card.Title tag="h2">
                  ...
                  <Card.Actions className="justify-center m-2">
                    <Button color="primary" className="md:w-full w-3/4 rounded-md" size="md">
                      {t('buy-now')}
                    </Button>
                  </Card.Actions>
                </Card>
